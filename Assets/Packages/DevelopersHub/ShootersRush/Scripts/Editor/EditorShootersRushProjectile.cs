namespace DevelopersHub.ShootersRush.Editor
{
    ...
    [CustomEditor(typeof(ShootersRushProjectile))] public class EditorShootersRushProjectile : Editor
    {

        private ShootersRushProjectile _projectile = null;
        ...
        private void OnEnable()
        {
            ...
            _projectile = (ShootersRushProjectile)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.HelpBox("The ID should not be empty. Please choose an ID for this projectile.", MessageType.Error);
                EditorGUILayout.Space();
            }
            else if (_duplicateID)
            {
                EditorGUILayout.HelpBox("This ID is also used by other projectiles. Please choose another ID to avoid any issues in your project.", MessageType.Error);
                EditorGUILayout.Space();
            }
